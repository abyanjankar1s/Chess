...
# this class will naviagte the board. 
class Square:
...
class ChessBoard:
    ...
    def initialize_board_and_piece(self):
        for i in range(8):
            for j in range(8):
    ...
    def move_piece(self, current_player):
        while True:
            ...
            if not piece_to_move:
                print("There's no piece at the specified staring positiion.")
                continue
...
class ChessGame:
    ...
    def start_game(self):
        print("Welcome to Chess, Uppercase - White, Lowercase - Black.")
